...
extension BMQAViewModel {
    ...
    func newQA(id: String, content: String, finishedCallback : @escaping (_ result: AnyObject) -> ()){
        let urlString = SERVICE_API_DOMAIN + "/mobile/api/v1/questions/new"
        let params = ["mobile_token": BMCurrentUser.token(), "id": id, "content": content]
        NetworkTools.requestData(type: .GET, URLString: urlString, parameters: params as NSDictionary) { (result) in
    ...
    func markAnswered(id: String,  finishedCallback : @escaping (_ result: AnyObject) -> ()){
        let urlString = SERVICE_API_DOMAIN + "/mobile/api/v1/questions/answered"
    ...
    func delete(id: String,  finishedCallback : @escaping (_ result: AnyObject) -> ()){
        let urlString = SERVICE_API_DOMAIN + "/mobile/api/v1/questions/delete"
        let params = ["mobile_token": BMCurrentUser.token(), "qa_id": id]
    ...
    func vote(id: String,  finishedCallback : @escaping (_ result: AnyObject) -> ()){
        let urlString = SERVICE_API_DOMAIN + "/mobile/api/v1/questions/vote"
        let params = ["mobile_token": BMCurrentUser.token(), "qa_id": id]
        NetworkTools.requestData(type: .GET, URLString: urlString, parameters: params as NSDictionary) { (result) in
    ...
    func requestData(id: String, page: Int = 1, count: Int = 100, finishedCallback : @escaping () -> ()){
        let urlString = SERVICE_API_DOMAIN + "/mobile/api/v1/questions"
