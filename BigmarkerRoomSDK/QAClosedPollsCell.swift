...
class QAClosedPollsCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        closePollBtn.titleLabel?.font = UIFont.systemFont(ofSize: 12)
        closePollBtn.addTarget(self, action: #selector(QAClosedPollsCell.closePollBtnClick), for: .touchUpInside)
        ...
        deletePollBtn.titleLabel?.font = UIFont.systemFont(ofSize: 12)
        deletePollBtn.addTarget(self, action: #selector(QAClosedPollsCell.deletePollBtnClick), for: .touchUpInside)
...
//            deletePollBtn.frame = CGRectMake(0, 5, 80, 20)
        ...
        for i in (0...arr.count - 1) {
            ...
            //answerLabel的高度
            let answerLabelHeight = getLabelHeight(answerLabelText: choiceModel.choice, font: UIFont.systemFont(ofSize: 12), width: ScreenW - 100)
            ...
            voteCount.font = UIFont.systemFont(ofSize: 12)
