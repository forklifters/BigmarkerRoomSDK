...
//        let cell = tableView.cellForRowAtIndexPath(selectIndexPath) as! BMPersionCell
//        cell.badgeLabel.text = "0"
//        cell.badgeLabel.hidden = true
//        
//        let privateChatController = BigRoomPrivateChatController()
...
//        self.presentViewController(privateChatController, animated: false, completion: nil)
       // self.navigationController?.pushViewController(privateChatController, animated: true)
