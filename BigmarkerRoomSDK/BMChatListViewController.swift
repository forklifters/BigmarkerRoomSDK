//
//  BMChatListViewController.swift
//  bigmarker
//
...
class BMChatListViewController: UIViewController {
    ...
    lazy  var tableView : UITableView = { [weak self] in
        let h: CGFloat = ScreenH  - TabbarH - messageInputViewH - 64 - 50
...
extension BMChatListViewController {
   ...
   func checkRepeatMessage(msg: Message) -> Bool{
    ...
    func setUpRefreshView(){
        let view = UIView(frame: CGRect(x: 0, y: 64, width: ScreenH, height: 53))
        view.backgroundColor = UIColor.white
        refreshButton = UIButton(frame: CGRect(x: 10, y: 10, width: ScreenW-20, height: 35))
