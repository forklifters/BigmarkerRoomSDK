...
//        let frame = CGRect.init(x: 0, y: self!.statusView.frame.height, width: ScreenW, height: h)
        ...
        tableView.register(UINib(nibName: "QATableViewCell", bundle: nil), forCellReuseIdentifier: QACellID)
     ...
     lazy var messageInputView: MessageInputView = { [weak self] in
        ...
        messageInputView.inputTextView.font = UIFont.systemFont(ofSize: 15)
...
extension BMQAViewController {
    ...
    func setupUI(){
     ...
     func loadData(){
        ...
        self.questionViewModel.requestData(id: self.conference!.obfuscatedId!) {
