...
- (void)addPullToRefreshWithAction:(NSString *)pushType Handler:(void (^)(void))actionHandler {
...
//    self.arrow.hidden = hasCustomView;
    ...
    if ([self.pushType isEqualToString:@"pushType"]) {
        self.titleLabel.hidden = YES;
        self.subtitleLabel.hidden = YES;
        self.arrow.hidden = YES;
        self.activityIndicatorView.center = CGPointMake(self.frame.size.width *0.5, self.frame.size.height *0.5);
